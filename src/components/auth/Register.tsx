    ...
    return (
        <View style={registrationStyles.container}>
            <View style={{ gap: 20, width: "80%" }}>
                ...
                <TouchableOpacity onPress={() => handleSelection(SelectionType.forgot)}
                    style={registrationStyles.flexRight}><Text style={registrationStyles.linkText}>Forgot password?</Text></TouchableOpacity>
                {/* {error ? (
                ...
                <TouchableOpacity
                    style={[
                        ...
                        isSignUpDisabled ? registrationStyles.disabledButton : {},
                    ]}
                ...
                <View style={registrationStyles.footerContainer}>
                    <View style={{ flexDirection: "row", alignItems: "center" }}>
                        <Text style={registrationStyles.connectingText}>Already have an account? </Text>
                        <TouchableOpacity
